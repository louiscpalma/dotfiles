# Generated by Powerlevel10k configuration wizard on 2020-09-20 at 11:58 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 46158.
...
() {
  ...
  typeset -g POWERLEVEL9K_IP_INTERFACE='(w|e).*'
  # Custom icon.
